...
homebuttonLib_lib_src	= HBMFrameController.cpp HBMAnmController.cpp HBMGUIManager.cpp HBMController.cpp HBMRemoteSpk.cpp HBMAxSound.cpp HBMCommon.cpp HBMBase.cpp lyt_animation.cpp lyt_arcResourceAccessor.cpp lyt_bounding.cpp lyt_common.cpp lyt_drawInfo.cpp lyt_group.cpp lyt_init.cpp lyt_layout.cpp lyt_material.cpp lyt_pane.cpp lyt_picture.cpp lyt_resourceAccessor.cpp lyt_textBox.cpp lyt_window.cpp math_arithmetic.cpp math_equation.cpp math_geometry.cpp math_triangular.cpp math_types.cpp ut_binaryFileFormat.cpp ut_CharStrmReader.cpp ut_CharWriter.cpp ut_Font.cpp ut_LinkList.cpp ut_list.cpp ut_ResFont.cpp ut_ResFontBase.cpp ut_RomFont.cpp ut_TagProcessorBase.cpp ut_TextWriterBase.cpp mix.cpp syn.cpp synctrl.cpp synenv.cpp synmix.cpp synpitch.cpp synsample.cpp synvoice.cpp seq.cpp
